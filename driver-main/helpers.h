...
// Shared Memory Vars
const WCHAR g_SharedSectionName[] = L"\\BaseNamedObjects\\champainvf";
...
// Shared Memory Vars
const WCHAR g_SharedSectionName_esp[] = L"\\BaseNamedObjects\\champainvf58";
...
BOOLEAN call_kernel_function_ts(void* kernel_function_address) {
	...
	PVOID* dxgk_routine
		= (PVOID*)(get_system_module_export("\\SystemRoot\\System32\\drivers\\dxgkrnl.sys", "NtDxgkVailPromoteCompositionSurface"));

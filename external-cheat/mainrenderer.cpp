...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	UnregisterClass(" ", (HINSTANCE)hInst);
...
void WINAPI UpdateSurface(HWND hWnd) {
	...
	tWnd = FindWindow(NULL, "Rust"); //WIN NAME

	if (!tWnd && hWnd && !UNLOADING && !NOTFOUND) { ShowWindow(hWnd, SW_HIDE); MessageBox(NULL, "Game closed, shutting down Rust Cheat!", "null.softwares", MB_OK | MB_ICONINFORMATION); UNLOADING = TRUE; }
